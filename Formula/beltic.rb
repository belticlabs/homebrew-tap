class Beltic < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/belticlabs/beltic-cli/releases/download/v0.1.0/beltic-aarch64-apple-darwin.tar.gz"
      sha256 "373ed589d9e753706091dac4f128a9e8668e2b472d61ec153dc7da674b8a3520"
    end
    on_intel do
      url "https://github.com/belticlabs/beltic-cli/releases/download/v0.1.0/beltic-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/belticlabs/beltic-cli/releases/download/v0.1.0/beltic-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "4d90fbe38df38e8252c9040f9129df4fb21623bb75fb2d16740cf77975d69915"
    end
    on_intel do
      url "https://github.com/belticlabs/beltic-cli/releases/download/v0.1.0/beltic-x86_64-unknown-linux-gnu.tar.gz"
